...
function News() {
  ...
  src="/cars.jpeg"
  alt="car"
  className="w-[275px] h-[1000px] object-fill ml-20 filter grayscale opacity-80"
/>
        </div>
        ...
        <div className='info bg-[#212121]        ' >
          ...
          <div className='row-1 relative pt-10'>
            <div className='w-1 h-5 bg-[#FF8C00] absolute left-24 rotate-90'></div>
            <h1 className='text-white px-20 py-4'>latest</h1>
          </div>
          <Info 
