...
function Footer() {
  ...
  return (
    <div className='bg-[#131311]  w-full p-20 '>
      ...
      <div className="w-full sm:flex flex-col   items-center justify-center lg:flex-row lg:flex lg:justify-between ">
        {/* First Column */}
        <div className='col-1 text-white  mt-25 lg:w-1/2  sm:w-full md:w-full'>
          ...
          <div className='address flex items-center gap-3 mt-4'>
            ...
            <div className='info flex flex-col'>
              <h1>Email</h1>
              <p className='text-[#FFECC8]   text-xs sm:text-sm md:text-base lg:text-lg'>Flagperformance@gmail.com</p>
            </div>
          </div>
        ...
        <div className='form bg-[#1A1A1A]  p-10 pb-10 lg:w-1/2   sm:w-full md:w-full'>
